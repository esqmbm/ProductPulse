  ...
  return (
    <section id="calculator" className="md:w-3/4">
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <p className="mb-6">
          This web tool helps privacy professionals evaluate data processing activities by calculating a risk score from likelihood and impact severity ratings. It clearly indicates whether a privacy risk is Low, Moderate, High or Severe aiding in decision-making and privacy risk mitigation.
        </p>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-medium">Impact Level (1-5) [Degree of Harm]:</FormLabel>
                  <Select 
